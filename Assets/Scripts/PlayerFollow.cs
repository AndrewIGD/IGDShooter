...
public class PlayerFollow : MonoBehaviour
{
    ...
    private void GetNewTarget()
    {
        ...
        {
            if(RoundData.Instance.SpawnedBomb != null)
                transform.position = new Vector3(RoundData.Instance.SpawnedBomb.transform.position.x, RoundData.Instance.SpawnedBomb.transform.position.y, -10);
        }
    }
}
